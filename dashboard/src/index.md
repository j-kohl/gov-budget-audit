...
Les dépenses du gouvernement du Canada et du gouvernement du Québec, à partir
des comptes publics des deux ordres de gouvernement. Les contrats publics
québécois font l'objet d'une [section distincte](./contracts).
...
## Les plus gros postes du fédéral et du Québec
...
resize((width) => Plot.plot({
  ...
  marks: [
    Plot.barX(progs(FED, "appropriation").slice(0, 15), {
      ...
      fill: "#4269d0",
      tip: {format: {x: money}, channels: {Ministères: "organizations"}}
    }),
    Plot.ruleX([0])
  ]
}))
...
Un même crédit — « Operating/Program », « Capital » — existe dans presque tous
les ministères ; les montants sont ici additionnés sur l'ensemble du
gouvernement.
...
## Fédéral — les transferts, poste par poste
...
## Fédéral — autorisé contre dépensé
